...
export function KanbanCard({ task, talents, onEdit, overlay }: KanbanCardProps) {
    ...
    return (
        ...
        >
            <div ref={setDroppableRef} className="w-full min-w-0 max-w-full">
                <motion.div
                ...
                >
                    <Card
                        onClick={handleClick}
                        className={cn(
                            "cursor-grab active:cursor-grabbing hover:shadow-[0_20px_50px_-12px_rgba(79,70,229,0.1)] transition-all duration-300 rounded-2xl md:rounded-[32px] border-zinc-100 shadow-sm bg-white overflow-hidden w-full max-w-full min-w-0 box-border",
